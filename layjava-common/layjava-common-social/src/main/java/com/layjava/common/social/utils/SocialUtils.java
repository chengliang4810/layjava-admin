...
import com.layjava.common.core.checker.Assert;
...
import com.layjava.common.social.maxkey.AuthMaxKeyRequest;
...
public class SocialUtils {
    ...
    private static final AuthRedisStateCache STATE_CACHE = Solon.context().getBean(AuthRedisStateCache.class);
    ...
    public static AuthRequest getAuthRequest(String source, SocialProperties socialProperties) throws AuthException {
        ...
        return switch (source.toLowerCase()) {
            ...
            case "wechat_enterprise" ->
                    new AuthWeChatEnterpriseQrcodeRequest(builder.agentId("" ).build(), STATE_CACHE);
