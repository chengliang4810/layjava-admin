...
public class SysSocialBo extends BaseEntity {
     ...
     * 的唯一ID
     */
    @NotBlank(message = "的唯一ID不能为空", groups = {AddGroup.class, UpdateGroup.class})
    private String authId;

    /**
     * 用户来源
     */
    @NotBlank(message = "用户来源不能为空", groups = {AddGroup.class, UpdateGroup.class})
    private String source;

    /**
     * 用户的授权令牌
     */
    @NotBlank(message = "用户的授权令牌不能为空", groups = {AddGroup.class, UpdateGroup.class})
     ...
     * 用户的 ID
     */
    @NotBlank(message = "用户的 ID不能为空", groups = {AddGroup.class, UpdateGroup.class})
    private Long userId;
