...
import com.layjava.common.core.utils.file.MimeTypeUtils;
...
import com.layjava.system.domain.bo.SysUserPasswordBo;
...
public class SysProfileController extends BaseController {
    ...
    public R<AvatarVo> avatar(UploadedFile avatarfile) throws IOException {
        if (!avatarfile.isEmpty()) {
            String extension = FileUtil.extName(avatarfile.getName());
