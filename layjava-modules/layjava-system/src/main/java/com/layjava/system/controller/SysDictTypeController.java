...
public class SysDictTypeController extends BaseController {
    ...
    @Get
    @Mapping("/list")
    public PageResult<SysDictTypeVo> list(SysDictTypeBo dictType, PageQuery pageQuery) {
    ...
    @Post
    @Mapping("/export")
    public void export(SysDictTypeBo dictType) {
    ...
    public R<SysDictTypeVo> getInfo(Long dictId) {
    ...
    @Post
    @Mapping
    public R<Void> add(SysDictTypeBo dict) {
    ...
    @Put
    @Mapping
    public R<Void> edit(SysDictTypeBo dict) {
        if (!dictTypeService.checkDictTypeUnique(dict)) {
